...
class Not_ibhakSailer(Sailer):
    def start(self):
        self.category = '입학정보'
        for i in range(1, 15):
            self.page_url = "http://www.skku.edu/new_home/campus/skk_comm/notice_list.jsp?page={}&bCode=6&skey=BOARD_SUBJECT&keyword=".format(i)
            self.page()
