...
class SscienceSailer(Sailer):
    def start(self):
        self.category = '사회과학대학'
        self.top = False
        for i in range(0, 30):
            self.page_url = "http://sscience.skku.edu/sscience/menu_4/sub4_1.jsp?mode=list&board_no=219&pager.offset={}0".format(i)
