...
class Not_illbanSailer(Sailer):
    def start(self):
        self.category = '일반'
        for i in range(1, 250):
            self.page_url = "http://www.skku.edu/new_home/campus/skk_comm/notice_list.jsp?page={}&bCode=2&skey=BOARD_SUBJECT&keyword=".format(i)
            self.page()
