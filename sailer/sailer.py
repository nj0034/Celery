...
from sailer.sentry import SailerLogger
...
class Sailer:
    def __init__(self):
        ...
        # initialize driver
        self.driver = webdriver.PhantomJS(executable_path=r'C:\Users\user.user-PC\Downloads\phantomjs-2.1.1-windows\bin\phantomjs')
